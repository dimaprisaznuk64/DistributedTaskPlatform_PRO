...
| **1.4 (поточна)** | DLQ-моніторинг у дашборді (панель dead letter + ручний retry), refresh-токен-ліміт для WS, IP-ліміт повторного створення, CI-пайплайн (GitHub Actions: ruff + 68 тестів + compose-валідація) |
